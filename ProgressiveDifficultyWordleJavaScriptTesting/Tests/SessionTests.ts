...
import { ScoreHandlingInterface } from '../../ProgressiveDifficultyWordle/TypeScript/Interfaces/ScoreHandlingInterface';
...
describe("Session", () => {
    ...
    let scoreHandlerMock: TypeMoq.IMock<ScoreHandlingInterface>;
    let session: Session;
    ...
    beforeEach(() => {
        ...
        scoreHandlerMock = TypeMoq.Mock.ofType<ScoreHandlingInterface>();
    });
    ...
    describe("#constructor", () => {
        it('initializes session with new game, when GameType is Single.', () => {
            ...
            session = new Session(type, answerList, guessList, notify, gamePainterMock.object,
                scoreHandlerMock.object, hardMode);
        ...
        it('initializes session with new game, when Max Guesses are explicitly specified.', () => {
            ...
            let type = GameType.ProgressiveDifficulty;
            session = new Session(type, answerList, guessList, notify, gamePainterMock.object,
                scoreHandlerMock.object, hardMode, maxGuesses);
        ...
        it('initializes session with new game, when the Timer is enabled and a length is not explicitly specified.', () => {
            ...
            let type = GameType.ProgressiveDifficulty;
            session = new Session(type, answerList, guessList, notify, gamePainterMock.object,
                scoreHandlerMock.object, hardMode, maxGuesses, timerEnabled);
        ...
        it('initializes session with new game, when the Timer is enabled and a length is explicitly specified.', () => {
            ...
            let type = GameType.ProgressiveDifficulty;
            session = new Session(type, answerList, guessList, notify, gamePainterMock.object,
                scoreHandlerMock.object, hardMode, maxGuesses, timerEnabled, timerLength);
    ...
    describe("#next", () => {
        it('runs guesses until failure to solve when the GameType=Single and does not generate a new game after.', () => {
            ...
            scoreHandlerMock.verify(x => x.updateHighScores(GameType.Single, TypeMoq.It.isAny(),
                false, 6), TypeMoq.Times.once());
        ...
        it('runs guesses until successful when the GameType=Endless and subsequently generate a new game, never modifying the underlying state.', () => {
            ...
            scoreHandlerMock.verify(x => x.updateHighScores(GameType.Endless, TypeMoq.It.isAny()),
                TypeMoq.Times.never());
        ...
        it('runs guesses until successful when the GameType=ProgressiveDifficulty and subsequently generate a new game, never modifying the underlying state.', () => {
            ...
            scoreHandlerMock.verify(x => x.updateHighScores(GameType.ProgressiveDifficulty, TypeMoq.It.isAny()),
                TypeMoq.Times.never());
